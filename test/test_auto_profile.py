...
def main():
    ...
    print("Running Experiment (AutoProfile Semi-Supervised)...")
    methods = [OneClassSVM]
    param_spaces = [{'nu': [0.1]}]
    ...
    best_params = run_experiment(
        ...
        experiment_names=['Test_AutoProfile'],
        MAX_RUNS=1,
        MAX_JOBS=1,
        INITIAL_RANDOM=1,
        profile_size=[10, 20],
    ...
    experiment_name = 'Test_AutoProfile OneClassSVM'
    ...
    print("AutoProfile Semi-Supervised Test Successful.")
