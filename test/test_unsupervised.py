...
def main():
    ...
    print("Preparing Semi Dataset format (suitable for Unsupervised)...")
    train_data, test_data = dataset_obj.get_unsupervised_dataset()
    
    print("Running Experiment (Unsupervised)...")
    methods = [IsolationForestUnsupervised]
    ...
    best_params = run_experiment(
        ...
        method_names=['IsolationForestUnsupervised'],
        experiments=[UnsupervisedPdMExperiment],
        experiment_names=['Test_Unsupervised'],
        MAX_RUNS=1,
        MAX_JOBS=1,
        INITIAL_RANDOM=1,
    ...
    experiment_name = 'Test_Unsupervised IsolationForestUnsupervised'
    ...
    print("Unsupervised Test Successful.")
