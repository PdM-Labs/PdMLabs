...
def main():
    ...
    print("Running Experiment (Semi-Supervised)...")
    methods = [OneClassSVM]
    param_spaces = [{'nu': [0.1]}] # Dummy fast param space
    ...
    experiment_name = 'Test_SemiSupervised OneClassSVM'
    ...
    print("Semi-Supervised Test Successful.")
